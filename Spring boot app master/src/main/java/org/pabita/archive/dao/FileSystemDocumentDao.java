package org.pabita.archive.dao;
...
import org.pabita.archive.service.Document;
import org.pabita.archive.service.DocumentMetadata;
 ...
 * 
 *  <pabita.allada[at]gmail[dot]com>
 */
@Service("documentDao")
public class FileSystemDocumentDao implements IDocumentDao {
     ...
     * 
     * @see org.pabita.archive.dao.IDocumentDao#insert(org.pabita.archive.service.Document)
     */
    @Override
     ...
     * the parameter.
     * 
     * @see org.pabita.archive.dao.IDocumentDao#findByPersonNameDate(java.lang.String, java.util.Date)
     */
    @Override
     ...
     * 
     * @see org.pabita.archive.dao.IDocumentDao#load(java.lang.String)
     */
    @Override
